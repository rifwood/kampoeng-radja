        ...
        <div class="mx-auto max-w-[1380px] px-4 py-5 sm:px-6 lg:px-7">
            <div class="mb-5 border-b border-slate-200 pb-4">
                ...
                <p class="mt-1 max-w-2xl text-xs leading-5 text-slate-500">
                    Kelola konten yang tampil pada halaman utama Kampoeng Radja.
                </p>
            </div>
            ...
            <div class="space-y-3">
                <CmsSectionCard
                    title="Hero"
                    description="Konten utama pada bagian paling atas Beranda."
                    icon="HR"
                    :default-open="true"
                >
                ...
                <CmsSectionCard
                    title="Media & Berita"
                    description="Kelola berita terbaru yang tampil pada Beranda dan halaman publik."
                    icon="MB"
                >
                ...
                <CmsSectionCard
                    title="Promo"
                    description="Kelola promo yang tampil pada carousel Beranda."
                    icon="PM"
                    :default-open="true"
                >
                    <PromoManager
                ...
                <CmsSectionCard
                    title="Produk"
                    description="Kelola showcase paket, fasilitas, dan aktivitas Kampoeng Radja."
                    icon="PR"
                >
                ...
                <CmsSectionCard
                    title="Mitra"
                    description="Kelola logo Mitra yang ditampilkan pada Beranda."
                    icon="MT"
                >
